...
(function initCarousel() {
  ...
  function goToPage(n) {
    ...
    var parentStyle = getComputedStyle(track.parentElement);
    var visibleWidth = track.parentElement.clientWidth - parseFloat(parentStyle.paddingLeft) - parseFloat(parentStyle.paddingRight);
